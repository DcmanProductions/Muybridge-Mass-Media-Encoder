...
namespace MMMELibs
{
    public class ConfigUtilities
    {
        ...
        Reference reference;
        public ConfigUtilities(Reference _ref)
        {
            reference = _ref;
        ...
        public string LastUsedMediaDirectory
        {
            get
            {
                return last_used_media_directory;
            }
            set
            {
